...
class TtsUtilityPage(QWidget):
    ...
    def _init_ui(self):
        ...
        self.loaded_file_label.setToolTip("当前加载的词表文件名。")
        ...
        self.add_row_btn.setToolTip("在表格末尾添加一个空行。")
        self.remove_row_btn.setToolTip("删除表格中所有选中的行。")
        self.clear_table_btn.setToolTip("清空整个编辑列表。")
    ...
    def update_progress(self, value, text_format): 
        # ... (unchanged, statusBar integration already exists)
    ...
    def load_wordlist_from_file(self, filepath=None):
        ...
        # ... (rest of the loading logic is unchanged)
        try:
        ...
        for i, item_data in enumerate(items):
            ...
            for attempt in range(3): # 最多重试3次
                ...
                try:
                    ...
                    if attempt < 2: time.sleep(1.5) # 等待1.5秒后重试
