...
class ConverterPage(QWidget):
    def __init__(self, parent_window, WORD_LIST_DIR):
        ...
        self.setAcceptDrops(True) # --- [新增] 启用拖放 ---
        self._init_ui()
    ...
    def _init_ui(self):
        ...
        self.preview_label = QLabel("请先从左侧选择一个文件"); self.preview_table = QTableWidget(); self.preview_table.setEditTriggers(QTableWidget.NoEditTriggers); self.preview_table.setAlternatingRowColors(True)
        ...
        self.destination_combo = QComboBox(); self.confirm_btn = QPushButton("确认并开始转换"); self.confirm_btn.setObjectName("AccentButton")
